...
public class FunctionalTests
{
    ...
    {
        var builder1TypeName = "BimServices.BuilderGenerator.Tests.TestData.v1.TestEntityBuilder";
        var builder2TypeName = "BimServices.BuilderGenerator.Tests.TestData.v2.TestEntityBuilder";
        ...
        await Assert.That(runResult.GeneratedTrees
            .Any(gt => gt.FilePath == "BimServices.BuilderGenerator/BimServices.BuilderGenerator.BuilderGenerator/BimServices_BuilderGenerator_Tests_TestData_v1_TestEntityBuilder.cs")).IsTrue();
        
        object? builder1 = compiledAssembly.CreateInstance(builder1TypeName);
        await Assert.That(builder1).IsNotNull();
        
        await Assert.That(runResult.GeneratedTrees
            .Any(gt => gt.FilePath == "BimServices.BuilderGenerator/BimServices.BuilderGenerator.BuilderGenerator/BimServices_BuilderGenerator_Tests_TestData_v2_TestEntityBuilder.cs")).IsTrue();
